import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, createElementBlock, provide, cloneVNode, h, computed, unref, Suspense, nextTick, mergeProps, ref, Fragment, withCtx, createVNode, useSSRContext, defineAsyncComponent, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
import { $fetch } from "ofetch";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "C:/Users/Globalsym/Desktop/GestionContador/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "C:/Users/Globalsym/Desktop/GestionContador/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader } from "C:/Users/Globalsym/Desktop/GestionContador/node_modules/h3/dist/index.mjs";
...
import { toRouteMatcher, createRouter } from "C:/Users/Globalsym/Desktop/GestionContador/node_modules/radix3/dist/index.mjs";
import { defu } from "C:/Users/Globalsym/Desktop/GestionContador/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, withQuery, isScriptProtocol } from "C:/Users/Globalsym/Desktop/GestionContador/node_modules/ufo/dist/index.mjs";
import "C:/Users/Globalsym/Desktop/GestionContador/node_modules/klona/dist/index.mjs";
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-B6f24qoY.js")
  }
];
...
const store = () => createStore({
  ...
  mutations: {
    ...
    INCREMENTAR(state, id) {
      const c = state.contadores.find((c2) => c2.id === id);
      if (c && c.valor < 20) {
        c.valor++;
        localStorage.setItem("contadores", JSON.stringify(state.contadores));
      }
  ...
  getters: {
    contadoresFiltrados: (state) => {
      ...
      if (state.filtros.busqueda) {
        lista = lista.filter(
          (c) => c.nombre.toLowerCase().includes(state.filtros.busqueda.toLowerCase())
        );
      }
...
const vuex_Cb31k4Ks1qmWFXmcNgSBiNrvbaoWmDqoJPBvBovLj9Q = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-U-iitRpe.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-Dx_GBMiW.js"));
